...
//III : méthodes liées aux imagettes
  ...
  //4) envoie de l'url de toutes les tuiles dans la base de données
    ...
    .then(r => r.json())
    .then(r => {
      //affichage de la reussite ou de l'echec de l'insertion dans la base de données
      console.log(r);
      //simulation d'un nouvel evenement de saisi dans le champs de saisi afin de lancer à nouveau un check_unicity
